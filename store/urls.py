...
from .views import HomePage, ProductListView, ProductDetailView, OrderCreateView, ProfileOrderView, ProfileUpdateView, CartItemDeleteView, CartDetailView, UserCreateView, UserLoginView, ProductAddToCart
...
urlpatterns = [
    ...
    path('logout/', auth_views.LogoutView.as_view(
        next_page=reverse_lazy('store:store-home')), name='logout'),
