'''
Django settings for SkyShop project.
...
SECRET_KEY = 'django-insecure-bdhka4flwp@geblv#oq8m%jd9-6#m9&hd&(b@gqxca9-lu^=vc'
...
WSGI_APPLICATION = 'SkyShop.wsgi.application'
